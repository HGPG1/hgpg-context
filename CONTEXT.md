...
- **New Construction Guide** (newconstruction.homegrownpropertygroup.com) - shipped; see `projects/new-construction.md` for incentive triage protocol + builder refresh cadences
